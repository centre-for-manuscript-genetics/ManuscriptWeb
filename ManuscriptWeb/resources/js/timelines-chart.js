    ...
    update: function update(state) {
      ...
      function renderTimelines(maxElems) {
        ...
        var newSegments = timelines.enter().append('rect').attr('class', 'series-segment').attr('rx', 1).attr('ry', 1).attr('x', state.graphW / 2).attr('y', state.graphH / 2).attr('width', 0).attr('height', 0).style('fill', function (d) {
          ...
          if(d.data.color) {return d.data.color; }else{return state.zColorScale(d.val);}
       ...
       // var TextLabels = timelines.enter().append("text").attr("class","series-segment").attr('rx', 1).attr('ry', 1).attr('x', state.graphW / 2).attr('y', state.graphH / 2).attr('width', 0).attr('height', 0).text("cat");
       ...
       newSegments.on('mouseover', function () {
        ...
        .on('click', function (s) {
                ...
                d3Select(".series-segment-active").attr('style', function (d) {
                    console.log($(this).data("prevstyle"));
                    return $(this).data("prevstyle");
                  }).attr('class','series-segment');
                
                d3Select(this).attr('class', 'series-segment series-segment-active').attr("data-prevstyle",function(d){console.log($(this).attr("style")); return $(this).attr("style")}).attr('style', 'fill: #ff0000;');
        });
