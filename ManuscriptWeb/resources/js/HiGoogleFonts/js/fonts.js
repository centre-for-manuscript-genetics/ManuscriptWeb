 ...
 */
 ...
 /* 27/10/2020 minor adaption for ManuscriptWeb by JS */
			...
			//console.log(this);
				...
				this.select2({
					...
					templateResult: function (result) {
                        ...
                        //surpress a googlefonts call for the "seaching ..." item provided by select2
                        if (result.text=="Searching…"){item=""}
                        var state = $(item);
						return state;
					}
				});
